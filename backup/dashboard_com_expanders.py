...
with st.sidebar:
    ...
    with st.expander("💸 Filtro de Desconto", expanded=False):
    ...
    with st.expander("🧾 Condições da Oferta", expanded=False):
    ...
    with st.expander("💾 Salvar Configuração", expanded=False):
